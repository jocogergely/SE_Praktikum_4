...
${OBJECTDIR}/_ext/2037729719/FestoProcessAccess.o: ../Sources/FestoProcessAccess.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2037729719/FestoProcessAccess.o ../Sources/FestoProcessAccess.cpp

${OBJECTDIR}/_ext/2037729719/HeightSensor.o: ../Sources/HeightSensor.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2037729719
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2037729719/HeightSensor.o ../Sources/HeightSensor.cpp

${OBJECTDIR}/_ext/2037729719/TestClass.o: ../Sources/TestClass.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2037729719
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2037729719/TestClass.o ../Sources/TestClass.cpp

${OBJECTDIR}/_ext/2037729719/factory.o: ../Sources/factory.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2037729719
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2037729719/factory.o ../Sources/factory.cpp

${OBJECTDIR}/_ext/2037729719/fsm.o: ../Sources/fsm.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2037729719
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2037729719/fsm.o ../Sources/fsm.cpp

${OBJECTDIR}/_ext/2037729719/main.o: ../Sources/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2037729719
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2037729719/main.o ../Sources/main.cpp

${OBJECTDIR}/_ext/2037729719/minilab1008processimage.o: ../Sources/minilab1008processimage.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2037729719
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/2037729719/minilab1008processimage.o ../Sources/minilab1008processimage.cpp
